...
- **Standard**: [ERC-8265 Prepared Transaction Envelope](https://github.com/ethereum/ERCs/pull/1753) - draft PR open in `ethereum/ERCs` since 13 May 2026 (CI green). Public discussion on Ethereum Magicians (thread 28557).
