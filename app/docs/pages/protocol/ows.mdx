...
|---|---|---|
| `@txkit/tx-protocol` v0.2 on npm | ✅ published 2026-04-21 | - |
| [Spec v0.2 RFC](../../../../spec/v0.2/prepared-transaction.md) | ✅ in repo | - |
...
OWS v0.1 defines the signing contract. If OWS v0.2 adds an optional `Preview` or `Decode` sub-spec, the txKit moat narrows. The window to stake out the decode layer - with a live npm package and reference shape - is approximately 2-3 months.
...
- [Spec v0.1 RFC](../../../../spec/v0.1/prepared-transaction.md)
