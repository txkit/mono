# PreparedEnvelope spec v0.2

Canonical spec: [`spec/v0.2/prepared-transaction.md`](https://github.com/txkit/mono/blob/main/spec/v0.2/prepared-transaction.md).
...
v0.2 closes gaps identified in 2024-2026 incident review:
...
- [Full spec v0.2 RFC](https://github.com/txkit/mono/blob/main/spec/v0.2/prepared-transaction.md)
...
- [OWS composition](./ows)
- [v0.1 spec (DEPRECATED)](https://github.com/txkit/mono/blob/main/spec/v0.1/prepared-transaction.md)
