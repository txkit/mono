...
Canonical spec: [`spec/v0.1/prepared-transaction.md`](https://github.com/txkit/mono/blob/main/spec/v0.1/prepared-transaction.md).
...
- [Full spec v0.1 RFC](https://github.com/txkit/mono/blob/main/spec/v0.1/prepared-transaction.md)
