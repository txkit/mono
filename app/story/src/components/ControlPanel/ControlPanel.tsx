...
import IconSourceInput from './IconSourceInput'
...
const renderItem = (entry: ControlEntry, dimmed: boolean) => {
  ...
  const fullWidth = 'fullWidth' in entry.def ? entry.def.fullWidth : undefined
  ...
  return (
    ...
    >
      ...
      <div className="control-value">
        ...
        {entry.def.type === 'icon-source' && <IconSourceInput entry={entry} />}
      </div>
    </div>
  )
}
