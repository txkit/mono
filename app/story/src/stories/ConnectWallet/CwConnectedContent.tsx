    ...
    <>
      {
        showAvatar && (
          pixel
            ? (
              <span className="tx-cw-avatar-fallback" style={{ background: pixel.background, overflow: 'hidden' }} aria-hidden="true">
            ...
            : <span className="tx-cw-avatar-fallback" style={{ background: hashGradient(address) }} aria-hidden="true" />
        )
      }
      <span className="tx-cw-address">{displayAddress}</span>
      {
        showBalance && (
          <span className="tx-cw-balance-wrap">
            <span className="tx-cw-balance">{balance}</span>
            {showFiat && <span className="tx-cw-fiat">{fiat}</span>}
          </span>
        )
      }
    </>
