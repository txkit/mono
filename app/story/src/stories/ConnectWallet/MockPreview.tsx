      ...
      <div className="story-live-layout">
        <div className="story-live-left">
          ...
          <div className="story-live-preview-card">
            <div ref={wrapperRef} className={`tx-root ${txkitThemeClass} story-live-preview-inner`}>
              <CwMockButton
                state={currentState}
              ...
              >
                {dropdownOpen && canToggleDropdown && <CwMockDropdown wrongChain={currentState === 'wrong-chain'} onDisconnect={handleDisconnect} onSwitchChain={handleSwitchChain} />}
              </CwMockButton>
            </div>
          </div>
          <CodeBlock code={code} />
