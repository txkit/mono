...
/**
 * Client boundary for the header connect control. yield-swap/page.tsx is a server
 ...
 * pinned to the scenario's chain (Arbitrum Sepolia for yield-swap, Robinhood Chain
 * for rwa-buy) so the button surfaces txKit's wrong-network connect + switch UX
