...
export class InvalidConfigError extends TxKitError {
  ...
  static override code = 'TXKIT_INVALID_CONFIG' as const
...
export class ProviderNotFoundError extends TxKitError {
  ...
  static override code = 'TXKIT_PROVIDER_NOT_FOUND' as const
  constructor() {
...
export class MissingWagmiProviderError extends TxKitError {
  ...
  static override code = 'TXKIT_MISSING_WAGMI_PROVIDER' as const
  constructor() {
...
export class NestedProviderError extends TxKitError {
  ...
  static override code = 'TXKIT_NESTED_PROVIDER' as const
  constructor() {
