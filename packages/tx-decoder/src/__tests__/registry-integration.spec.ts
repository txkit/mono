...
// AgentPolicyGate integration tests live alongside the Buildathon example
// (examples/arbitrum-london/) and use the deployed address from
// `contracts/deployed.json`. They are intentionally NOT bundled into the
// published `@txkit/tx-decoder` registry so that consumers do not hit a
// placeholder-address descriptor for Arbitrum Sepolia / Robinhood Chain.
