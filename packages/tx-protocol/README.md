...
- [txKit docs](https://docs.txkit.dev)
- [Spec RFC](./spec/v0.1/prepared-transaction.md)
- [OWS composition](../../app/docs/pages/protocol/ows.mdx)

The v0.1 shape was hardened against the Drift, Bybit, Kelp, multicall-bait, and address-poisoning attack patterns. See the canonical spec for per-field rationale.
